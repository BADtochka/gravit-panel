<template>
  <section class="space-y-6">
      ...
      <Card>
        ...
        <CardFooter>
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                <AlertDialogTitle>Reinstall Prestarter?</AlertDialogTitle>
                <AlertDialogDescription>
                  LaunchServer will restart to initialize the Prestarter binary. Connected users will be interrupted.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
                <AlertDialogCancel>Cancel</AlertDialogCancel>
                <AlertDialogAction @click="runPrestarter">Reinstall Prestarter</AlertDialogAction>
              </AlertDialogFooter>
            </AlertDialogContent>
          </AlertDialog>
        </CardFooter>
    ...
    <JobProgressNotifier :job="activeJob" title="Launcher operation" @finished="jobFinished" />
  </section>
</template>
